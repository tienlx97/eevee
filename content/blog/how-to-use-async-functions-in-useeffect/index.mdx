...
<strong>useEffect</strong> is usually the place where data fetching happens in React. Data fetching means using asynchronous
functions, and using them in <strong>useEffect</strong> might not be as straightforward as you'd think. Read on to learn
more about it!
...
<SideNote type="success">
  You are using a linter right? If not, <a>you really should!</a>
</SideNote>
