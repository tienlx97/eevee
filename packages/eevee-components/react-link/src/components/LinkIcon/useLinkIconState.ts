...
import type { LinkIconState } from './LinkIcon.types';
import { useLocation } from 'react-router-dom';
/**
 * The useLinkIconState hook processes the Link state.
 * @param state - Link state to mutate.
 */
export const useLinkIconState = (state: LinkIconState): LinkIconState => {
