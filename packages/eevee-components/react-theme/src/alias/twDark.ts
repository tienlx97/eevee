...
export const generateColorTokens = (): ColorTokens => ({
  ...
  foreground8: 'hsl(53, 100%, 50%)',
  foreground9: 'hsl(210, 25%, 88%)',
  foreground10: 'hsl(210, 25%, 96%)',
  backgroundInfo: 'hsl(210, 38%, 15%)',
  backgroundSuccess: 'hsla(160, 100%, 40%, 0.1)',
  backgroundWarning: 'hsla(38, 100%, 50%, 0.1)',
  borderInfo: 'hsl(230, 100%, 67%)',
  borderSuccess: 'hsl(160, 100%, 40%)',
  borderWarning: 'hsl(30, 100%, 50%)',
