...
export const tokens: Record<keyof Theme, string> = {
  ...
  foreground8: 'var(--foreground8)',
  foreground9: 'var(--foreground9)',
  foreground10: 'var(--foreground10)',
  backgroundInfo: 'var(--backgroundInfo)',
  backgroundSuccess: 'var(--backgroundSuccess)',
