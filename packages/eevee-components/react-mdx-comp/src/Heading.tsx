...
export const H1 = (props: HeadingProps) => <Heading {...props} type="major-heading" />;
export const H2 = (props: HeadingProps) => <Heading {...props} type="normal-heading" />;
export const H3 = (props: HeadingProps) => <Heading {...props} type="minor-heading" />;
