import { createContext, ContextSelector, useContextSelector } from '@eevee/react-context-selector';
import type { Context } from '@eevee/react-context-selector';
...
export const DialogContext: Context<DialogContextValue | undefined> =
  createContext<DialogContextValue | undefined>(undefined);
