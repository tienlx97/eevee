...
var ea = !1;
function k(a, b) {
  ea && ((ea = !1), '<' !== b[0] && a.push('\x3c!-- --\x3e'));
  return '\x3c!-- --\x3e' === b ? (ea = !0) : a.push(b);
}
    ...
    if (p.call(c, d)) {
      ...
      if (null != f && 'boolean' !== typeof f && '' !== f) {
        if (0 === d.indexOf('--')) {
          ...
          void 0 !== g
            ? (e = g)
            : ((g = u(e.replace(pa, '-$1').toLowerCase().replace(qa, '-ms-'))), ua.set(e, g), (e = g));
...
var ya = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,
  za = new Map();
function A(a) {
  var b = za.get(a);
  if (void 0 === b) {
    if (!ya.test(a)) throw Error('Invalid tag: ' + a);
    b = '<' + a;
    za.set(a, b);
  }
  return b;
  ...
  switch (b) {
    ...
    case 'textarea':
      ...
      if (null != n) {
        ...
        if (ra(n) && 1 < n.length) throw Error('<textarea> can only have at most one child.');
        e = '' + n;
      }
      'string' === typeof e && '\n' === e[0] && a.push('\n');
      null !== e && a.push(u('' + e));
    ...
    case 'input':
      ...
      null !== n ? x(a, d, 'checked', n) : null !== l && x(a, d, 'checked', l);
    ...
    case 'missing-glyph':
      return xa(a, c, b, d);
    case 'html':
      return 0 === f.insertionMode && a.push('<!DOCTYPE html>'), xa(a, c, b, d);
    default:
      if (-1 === b.indexOf('-') && 'string' !== typeof c.is) return xa(a, c, b, d);
      a.push(A(b));
      g = e = null;
      for (m in c)
        if (p.call(c, m) && ((h = c[m]), null != h && 'function' !== typeof h && 'object' !== typeof h))
          switch (('className' === m && (m = 'class'), m)) {
            case 'children':
              e = h;
              break;
            case 'dangerouslySetInnerHTML':
            ...
            case 'suppressHydrationWarning':
              break;
            default:
              ja(m) && 'function' !== typeof h && 'symbol' !== typeof h && a.push(' ', m, '="', u(h), '"');
          }
      a.push('>');
      z(a, g, e);
      return e;
...
function Ca(a, b, c, d) {
  switch (c.insertionMode) {
    case 0:
    case 1:
      return k(a, '<div hidden id="'), k(a, b.segmentPrefix), (b = d.toString(16)), k(a, b), k(a, '">');
    case 2:
      return (
        k(a, '<svg aria-hidden="true" style="display:none" id="'),
        k(a, b.segmentPrefix),
        (b = d.toString(16)),
        k(a, b),
        k(a, '">')
    ...
    case 3:
      return (
        k(a, '<math aria-hidden="true" style="display:none" id="'),
        k(a, b.segmentPrefix),
        (b = d.toString(16)),
        k(a, b),
        k(a, '">')
    ...
    case 4:
      return k(a, '<table hidden id="'), k(a, b.segmentPrefix), (b = d.toString(16)), k(a, b), k(a, '">');
    case 5:
      return k(a, '<table hidden><tbody id="'), k(a, b.segmentPrefix), (b = d.toString(16)), k(a, b), k(a, '">');
    case 6:
      return k(a, '<table hidden><tr id="'), k(a, b.segmentPrefix), (b = d.toString(16)), k(a, b), k(a, '">');
    case 7:
      return k(a, '<table hidden><colgroup id="'), k(a, b.segmentPrefix), (b = d.toString(16)), k(a, b), k(a, '">');
    default:
...
function Da(a, b) {
  switch (b.insertionMode) {
    ...
    case 4:
      return k(a, '</table>');
    case 5:
      return k(a, '</tbody></table>');
    case 6:
      return k(a, '</tr></table>');
    case 7:
      return k(a, '</colgroup></table>');
    default:
      throw Error('Unknown insertion mode. This is a bug in React.');
  }
}
...
var C = Object.assign,
  ...
  Na = Symbol.for('react.server_context'),
  ...
  Ta = Symbol.for('react.scope'),
  Ua = Symbol.for('react.debug_trace_mode'),
...
function F(a) {
  var b = D;
  b !== a &&
    (null === b ? cb(a) : null === a ? bb(b) : b.depth === a.depth ? E(b, a) : b.depth > a.depth ? db(b, a) : eb(b, a),
    (D = a));
}
var fb = {
  isMounted: function () {
...
function ub(a, b, c) {
  ...
  if (a === H)
    if (((L = !0), (a = { action: c, next: null }), null === N && (N = new Map()), (c = N.get(b)), void 0 === c))
      N.set(b, a);
    else {
...
var yb = {
  ...
  R = null,
  zb = aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
function Ab(a) {
  console.error(a);
}
function S() {}
function Bb(a, b, c, d, f, e, g, h, l) {
  var m = [],
    n = new Set();
  b = {
    destination: null,
  ...
  c = T(b, 0, null, c);
  c.parentFlushed = !0;
  a = Cb(b, a, null, c, n, $a, null, hb);
  m.push(a);
  return b;
}
function Cb(a, b, c, d, f, e, g, h) {
  a.allPendingTasks++;
  ...
  if (null !== e && void 0 !== e) {
    ...
    if ('function' !== typeof c.getChildContext) d = g;
      ...
      for (var h in c)
        if (!(h in e))
          throw Error(
            (Za(d) || 'Unknown') + '.getChildContext(): key "' + h + '" is not defined in childContextTypes.',
          );
      d = C({}, g, c);
    }
    b.legacyContext = d;
...
function Hb(a, b, c, d, f) {
  if ('function' === typeof c)
    ...
    switch (
      ((f = b.blockedSegment),
      (e = Aa(f.chunks, c, d, a.responseState, f.formatContext)),
      (g = f.formatContext),
      ...
      case Pa:
        a: {
          ...
          var h = {
            ...
            l = T(a, f.chunks.length, h, f.formatContext);
          f.children.push(l);
          var m = T(a, 0, null, f.formatContext);
          m.parentFlushed = !0;
          b.blockedBoundary = h;
          b.blockedSegment = m;
          try {
            if ((Ib(a, b, d), (m.status = 1), X(h, m), 0 === h.pendingTasks)) break a;
          } catch (n) {
            (m.status = 4), U(a, n), (h.forceClientRender = !0);
          } finally {
            (b.blockedBoundary = c), (b.blockedSegment = f);
          }
          b = Cb(a, e, c, l, g, b.legacyContext, b.context, b.treeContext);
...
function W(a, b, c) {
  ...
  'string' === typeof c
    ? ((b = b.blockedSegment.chunks), a.responseState.generateStaticMarkup ? b.push(u(c)) : ta(b, c))
    : 'number' === typeof c &&
      ((b = b.blockedSegment.chunks), (c = '' + c), a.responseState.generateStaticMarkup ? b.push(u(c)) : ta(b, c));
}
function Jb(a, b, c) {
...
function Ib(a, b, c) {
  ...
  try {
    ...
    if ((rb(), 'object' === typeof l && null !== l && 'function' === typeof l.then)) {
      c = l;
      var g = b.blockedSegment,
        h = T(a, g.chunks.length, null, g.formatContext);
      g.children.push(h);
      a = Cb(a, b.node, b.blockedBoundary, h, b.abortSet, b.legacyContext, b.context, b.treeContext).ping;
      c.then(a, a);
      b.blockedSegment.formatContext = d;
      b.legacyContext = f;
      b.context = e;
      F(e);
    } else throw ((b.blockedSegment.formatContext = d), (b.legacyContext = f), (b.context = e), F(e), l);
  }
}
function Kb(a) {
...
function Mb(a) {
  ...
  null === b
    ? (this.allPendingTasks--,
      2 !== this.status && ((this.status = 2), null !== this.destination && this.destination.push(null)))
    : (b.pendingTasks--,
      b.forceClientRender || ((b.forceClientRender = !0), b.parentFlushed && this.clientRenderedBoundaries.push(b)),
      b.fallbackAbortableTasks.forEach(Mb, this),
      ...
      b.forceClientRender ||
        (0 === b.pendingTasks
          ? (c.parentFlushed && 1 === c.status && X(b, c),
            ...
            b.fallbackAbortableTasks.forEach(Kb, a),
            b.fallbackAbortableTasks.clear())
          : c.parentFlushed &&
            1 === c.status &&
            (X(b, c), 1 === b.completedSegments.length && b.parentFlushed && a.partialBoundaries.push(b)));
  a.allPendingTasks--;
    ...
    try {
      ...
      for (e = 0; e < f.length; e++) {
        ...
        if (0 === l.status) {
          F(g.context);
          try {
            W(h, g, g.node), g.abortSet.delete(g), (l.status = 1), Lb(h, g.blockedBoundary, l);
          } catch (w) {
            if ((rb(), 'object' === typeof w && null !== w && 'function' === typeof w.then)) {
              var m = g.ping;
              w.then(m, m);
            } else {
              g.abortSet.delete(g);
              ...
              null === n
                ...
                : (n.pendingTasks--,
                  n.forceClientRender ||
                    ((n.forceClientRender = !0), n.parentFlushed && h.clientRenderedBoundaries.push(n)));
              h.allPendingTasks--;
      ...
      f.splice(0, e);
      null !== a.destination && Nb(a, a.destination);
    } catch (w) {
      U(a, w), V(a, w);
    } finally {
      (R = d), (zb.current = c), c === yb && F(b);
    }
  }
}
function Y(a, b, c) {
  ...
  switch (c.status) {
    ...
    case 1:
      ...
      for (var g = 0; g < c.length; g++) {
        for (f = c[g]; e < f.index; e++) k(b, d[e]);
        f = Z(a, b, f);
      }
      for (; e < d.length - 1; e++) k(b, d[e]);
      e < d.length && (f = k(b, d[e]));
      return f;
    default:
      throw Error(
...
function Z(a, b, c) {
  ...
  if (d.forceClientRender)
    return (
      a.responseState.generateStaticMarkup || k(b, '\x3c!--$!--\x3e'),
      Y(a, b, c),
      (a = a.responseState.generateStaticMarkup ? !0 : k(b, '\x3c!--/$--\x3e')),
      a
    );
  if (0 < d.pendingTasks) {
...
function Ob(a, b, c) {
  Ca(b, a.responseState, c.formatContext, c.id);
  Z(a, b, c);
  return Da(b, c.formatContext);
}
function Pb(a, b, c) {
...
function Nb(a, b) {
  try {
    ...
    if (null !== c && 0 === a.pendingRootTasks) {
      ...
      for (c = 0; c < d.length - 1; c++) k(b, d[c]);
      c < d.length && k(b, d[c]);
    }
...
var Vb = (function (a) {
  ...
  c._read = function () {
    this.startedFlowing && Rb(this.request, this);
  };
  return b;
})(ba.Readable);
function Wb() {}
function Xb(a, b) {
  var c = new Vb(),
    d = Bb(
      a,
      Ea(!1, b ? b.identifierPrefix : void 0),
      Fa(),
      Infinity,
      Wb,
      function () {
