...
var z,
  ...
  D = q({}, y, {
    ...
    movementX: function (a) {
      ...
      a !== B &&
        (B && 'mousemove' === a.type ? ((z = a.screenX - B.screenX), (A = a.screenY - B.screenY)) : (A = z = 0),
        (B = a));
      return z;
    },
...
var ia = q({}, y, {
  key: function (a) {
    ...
    return 'keypress' === a.type
      ? ((a = r(a)), 13 === a ? 'Enter' : String.fromCharCode(a))
      : 'keydown' === a.type || 'keyup' === a.type
      ? ea[a.keyCode] || 'Unidentified'
      : '';
  },
  code: 0,
  location: 0,
...
function Aa(a, b, c) {
  a &&
    ...
    c._reactName &&
    (b = Y(a, c._reactName)) &&
    (null == c._dispatchListeners && (c._dispatchListeners = []),
    null == c._dispatchInstances && (c._dispatchInstances = []),
    c._dispatchListeners.push(b),
    c._dispatchInstances.push(a));
}
function Ba(a, b, c) {
  var d = c._reactName;
  ...
  return function (b, c) {
    ...
    l.unstable_batchedUpdates(function () {
      ...
      if (e) {
        ...
        if (L(a)) for (var d = 0; d < a.length && !e.isPropagationStopped(); d++) W(e, a[d], c[d]);
        else a && W(e, a, c);
