...
const config = {
  ...
  plugins: ['import', '@eevee', '@rnx-kit', '@typescript-eslint', 'deprecation', 'jest', 'jsdoc'],
  settings: {
    'import/resolver': {
  ...
  rules: {
    ...
    // permanently disable due to performance issues (using custom rule `@eevee/max-len` instead)
    'max-len': 'off',
    ...
    /**
     * `@eevee` eslint rules / This package
     * @see https://www.npmjs.com/package/@eevee/eslint-plugin
     */
    '@eevee/ban-imports': [
      'error',
      {
    ...
    '@eevee/no-tslint-comments': 'error',
