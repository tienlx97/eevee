...
export const Publishdialog = ({
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(event, daata) => setOpen(daata.open)}>
        <DialogSurface
          style={{
            top: '0',
            left: '0',
        ...
        >
          <DialogTitle>Advance Config :</DialogTitle>
          <DialogBody>
            <InputGroup
              type="tag"
              defaultTags={tags}
            ...
            <div style={{ marginTop: '24px' }}>
              <TextLink href="https://help.medium.com/hc/en-us/articles/360018677974">Learn more</TextLink> about what
          ...
          <DialogActions>
            <button
              className={mergeClasses(
                styles.publishNow,
                datePickErrors !== null && isSchedule && styles.publishDisabled,
              )}
            ...
            <DialogTrigger>
              <Button style={{ fontSize: '14px' }}>Close</Button>
            </DialogTrigger>
          </DialogActions>
        </DialogSurface>
      </Dialog>
