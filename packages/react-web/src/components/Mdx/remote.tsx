...
export type MDXRemoteProps = Pick<MDXRemoteSerializeResult, 'frontmatter' | 'compiledSource' | 'scope'> & {
  /**
 ...
 */
export const MDXRemote = ({ compiledSource, frontmatter, scope, lazy }: MDXRemoteProps) => {
  ...
  const content = (
    <mdx.MDXProvider components={MDXComponents}>
      <Content />
    </mdx.MDXProvider>
  );
