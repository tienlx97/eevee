...
import { RightLayoutSlots, RightLayoutState } from './RightLayout.types';
import { Link } from 'react-router-dom';

/**
 * Render the final JSX of Right
 */
export const renderRightLayout = (state: RightLayoutState) => {
  const { styles } = state;
  const { slots, slotProps } = getSlots<RightLayoutSlots>(state);
