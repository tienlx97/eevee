...
const envConfig = {
  ...
  dir_build: 'scripts',
  dir_docs: 'packages/eevee/docs',
  dir_docs_dist: 'packages/eevee/docs/dist',
  dir_docs_src: 'packages/eevee/docs/src',
  dir_e2e: 'packages/eevee/e2e',
  dir_e2e_tests: 'packages/eevee/e2e/tests',
  dir_e2e_src: 'packages/eevee/e2e/server',
  dir_e2e_dist: 'packages/eevee/e2e/dist',
  dir_packages: 'packages/eevee',
  dir_perf: 'packages/eevee/perf',
  dir_perf_dist: 'packages/eevee/perf/dist',
  dir_perf_src: 'packages/eevee/perf/src',
